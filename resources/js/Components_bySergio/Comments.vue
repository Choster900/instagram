<template>
    <div class="text-sm mb-2 ml-4 flex flex-start items-center">
        <a href="#"
            ...
            <img class="h-8 w-8 rounded-full object-cover" :src="urlImage">
        </a>
        <p class="font-bold ml-2">
            <a class="cursor-pointer">{{ nick_name }}: </a>
...
<script>
    export default {
        props: ["comment", "nick_name", "urlImage"],
    }
</script>
