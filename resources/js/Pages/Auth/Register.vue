...
import AuthenticationCard from '@/Components_bySergio/AuthenticationCard.vue';
...
<template>
    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                <InputLabel for="nickname" value="Nick name" />
                <TextInput id="nick_name" v-model="form.nick_name" type="text" class="mt-1 block w-full" required autofocus/>
                <InputError class="mt-2" :message="form.errors.name" />
            </div>
