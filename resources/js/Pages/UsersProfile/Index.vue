      ...
      <div class="flex justify-center pb-10">
        ...
        <div class="ml-10">
          ...
          <ul class="flex justify-content-around items-center">
            <li>
              <span class=" text-base flex"><span class="font-bold mr-2">{{ postCount }}
                </span>
                publicaciones
              </span>
            </li>
            ...
            <li>
              <span class="cursor-pointer  text-base flex ml-5"><span class="font-bold mr-2">{{ followers }}
                </span>
                seguidores
              </span>
            </li>
            ...
            <li>
              <span class="cursor-pointer  text-base flex ml-5"><span class="font-bold mr-2">{{ followed }}
                </span>
                seguidos
              </span>
            </li>
